    ...
    <div class="container mx-auto px-4 py-8 flex">
        <div class="w-2/3 mr-4">
            ...
            <div class="bg-transparent p-4 rounded shadow">
                <!-- Loop through the latest posts and display them -->
                @foreach($posts as $post)
                <article class="w-1/3 flex max-w-xl flex-col items-start justify-between">
        ...
        <div class="w-1/3">
            ...
            <div class="bg-white p-4 rounded shadow">
                <!-- Loop through the categories and display them -->
                    ...
                    <div class="mb-2">
                        <a href="#" class="text-blue-500 hover:text-blue-700">Category</a>
                    </div>
